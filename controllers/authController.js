...
exports.login = catchAsync(async (req, res, next) => {
  ...
  // .select('+password') is when we set in model select: false
...
//  3) Update changePasswordAt proprety the user
...
//  3) If so, update password
  user.password = req.body.password;
  user.passwordConfirm = req.body.passwordConfirm;
  // .findAndUpdate will not work because of validation on model for password and 2 pre save midelware will not work so we have to use .save()
  await user.save();
